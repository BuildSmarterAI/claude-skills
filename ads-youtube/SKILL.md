...
2. Read HYROS data and extract YouTube attribution from `attribution.platform_attribution.youtube`
3. Compare YouTube view-through conversions vs HYROS attribution (YouTube inflates via view-through)
4. Use HYROS to determine true YouTube impact on revenue
...
YouTube typically over-reports by 25-50% due to view-through attribution on video views.
HYROS is especially valuable for YouTube to separate true direct-response impact
from view-through inflation.
