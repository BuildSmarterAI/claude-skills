...
2. Read HYROS data and extract Microsoft attribution from `attribution.platform_attribution.microsoft`
3. Compare Microsoft-reported conversions vs HYROS attribution
4. Validate Google import accuracy with independent HYROS data

| Metric | Microsoft-Reported | HYROS-Attributed | Variance |
|--------|-------------------|------------------|----------|
| Conversions | X | Y | Z% |
| Revenue | $X | $Y | Z% |
| ROAS | X.Xx | Y.Yx | Z% |

Microsoft typically over-reports by 10-20%. HYROS can validate whether
Google-imported conversion tracking is accurately reflecting in Microsoft data.
