...
2. Read HYROS data and extract TikTok attribution from `attribution.platform_attribution.tiktok`
3. Compare TikTok-reported conversions vs HYROS attribution (TikTok notorious for over-reporting)
4. Verify ttclid passback accuracy using HYROS data
5. Use HYROS to identify true ROAS for TikTok campaigns

| Metric | TikTok-Reported | HYROS-Attributed | Variance |
|--------|----------------|------------------|----------|
| Conversions | X | Y | Z% |
| Revenue | $X | $Y | Z% |
| ROAS | X.Xx | Y.Yx | Z% |

TikTok typically over-reports by 30-60% due to aggressive view-through attribution.
HYROS is critical for TikTok to determine true campaign profitability.
